...
class PermissionActivityQ: AppCompatActivity() {
     ...
     *
     * permission needed for android version 10 (Q)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        next_button.setOnClickListener{
            if(checkPermission(android.Manifest.permission.ACCESS_FINE_LOCATION) && checkPermission(android.Manifest.permission.ACCESS_BACKGROUND_LOCATION)){
                gps_check_button.visibility = View.INVISIBLE
                findViewById<View>(R.id.view_gps).alpha = 0.5f
            } else{
    ...
    private fun checkLocationPermission() {
        if(ContextCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED){
            if (ContextCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_BACKGROUND_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(this, arrayOf(android.Manifest.permission.ACCESS_BACKGROUND_LOCATION, android.Manifest.permission.ACCESS_FINE_LOCATION), BACKGROUND_LOCATION_PERMISSION_REQUEST)
            }
        }
    }
